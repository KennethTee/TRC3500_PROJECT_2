...
def classify_height(object_type, peak, energy,num_peaks):
    ...
    if object_type == "taack":




        if peak < 1100: #671,598,612,524,
            print(energy)
            print(peak)
            print(num_peaks)
            return "30cm distance,30cm height" #height
    
        elif peak >= 950 and peak <=2000:
            print(energy)
            print(peak)
            print(num_peaks)
            return "10cm distance, 10cm height" #height
        
        elif peak>2000 : #1600 -1700-2000,1846 #12 #15 ,14,11,14,12
            print(energy)
            print(peak)
            print(num_peaks)
            return "10cm distance, 30cm height" #height
        
        elif (peak<1000 and energy >4e5): #2237,1464,
            print(energy)
            print(peak)
            print(num_peaks)
